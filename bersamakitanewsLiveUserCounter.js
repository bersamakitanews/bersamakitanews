/*
   bersamakitanewsLiveUserCounter Object for Core-Developers
*/

// Chapter 1: Beginning
if (typeof jQuery !== 'function') {
  var warnJQueryUndefinedStr = 'bersamakitanewsLiveUserCounter.js needs jQuery 1.1x.x to run properly!';
...
// Chapter 3: bersamakitanewsLiveUserCounter Context as ctx
var bersamakitanewsLiveUserCounter = {};

(function(ctx) {

  ctx.headerInfo = '[bersamakitanewsLiveUserCounter]';
  ctx.version    = 'v1.11';
...
})(bersamakitanewsLiveUserCounter);

// for using it, please call these lines :
// bersamakitanewsLiveUserCounter.setConfig({ .. });
// bersamakitanewsLiveUserCounter.start();
